			...
			"dialogue": [
				...
				},
				{
					...
					"content": {
						...
						"french": "Autour des affligés, des fleurs fantômes s'épanouissaient et disparaissaient étrangement.",
						"spanish": "Alrededor de los afligidos, flores fantasma florecían y desaparecían misteriosamente.",
				...
				},
				{
					"content": {
						...
						"spanish": "Las ilusiones… están alimentando la envidia. El bosque se nutre de ello y crece.",
				...
				},
				{
					"content": {
						...
						"english": "The roots of ancient trees move as if whispering. The forest is suffering too.",
						"japanese": "古い木の根が囁くように蠢く。森も苦しんでいる。",
						"chinese": "古老树木的根部像在低语般蠕动着。森林也在痛苦。",
						"french": "Les racines des arbres anciens bougent comme des murmures. La forêt souffre aussi.",
						"spanish": "Las raíces de los árboles antiguos se mueven como susurrando. El bosque también está sufriendo.",
			...
			"dialogue": [
				...
				},
				{
					...
					"content": {
						...
						"french": "Le fantôme de l'envie... c'est votre ombre. Avez-vous le courage de l'affronter ?",
						"spanish": "El fantasma de la envidia... es vuestra sombra. ¿Tenéis el valor de enfrentarlo?",
			...
			"win_dialogue": [
				{
					...
					"content": {
						...
						"english": "Heh heh... I won't disappear... Envy... will be reborn... as another phantom...",
						"japanese": "クク…消えはしない…嫉妬は…別の幻影として…再び生まれる…だろう…",
						"chinese": "呵呵…不会消失的…嫉妒会…以另一个幻影…再次重生…",
						"french": "Huhu... Je ne disparaîtrai pas... L'envie... renaîtra... sous une autre forme...",
						"spanish": "Jeje... No desapareceré... La envidia... renacerá... como otro fantasma...",
						"vietnamese": "Khà khà… Ta sẽ không biến mất… Lòng ghen tị… sẽ tái sinh… thành một ảo ảnh khác…",
				...
				},
				{
					"emotion": "base",
					"content": {
						"korean": "질투의 환영은 사라졌지만, 숲은 여전히 깊은 상처를 품고 있었다. 거울은 깨졌으나, 그 조각들은 더욱 날카로웠다.",
						"english": "The illusion of envy vanished, yet the forest still bore deep wounds. The mirror shattered, but its fragments grew sharper.",
						"japanese": "嫉妬の幻影は消え去ったが、森は深い傷を抱えたままだった。鏡は砕け散ったが、その破片はさらに鋭利になった。",
						"chinese": "嫉妒的幻影消失了，但森林仍怀揣着深深的伤痕。镜子碎裂，但其碎片却更加锋利。",
						"french": "L'illusion de l'envie s'était évanouie, mais la forêt portait toujours de profondes blessures. Le miroir était brisé, mais ses fragments étaient devenus plus tranchants.",
						"spanish": "La ilusión de la envidia se desvaneció, pero el bosque aún albergaba heridas profundas. El espejo se rompió, pero sus pedazos se volvieron más afilados.",
						"vietnamese": "Ảo ảnh ghen tỵ đã biến mất, nhưng khu rừng vẫn mang những vết sẹo sâu sắc. Gương đã vỡ, nhưng những mảnh vỡ của nó lại càng sắc bén hơn.",
						"thai": "ภาพลวงตาแห่งความอิจฉาเลือนหายไป แต่ป่ายังคงแบกรับบาดแผลลึก กระจกแตกสลาย ทว่าเศษเสี้ยวของมันกลับคมกริบยิ่งขึ้น",
						"hindi": "ईर्ष्या का भ्रम मिट गया, फिर भी जंगल में गहरे घाव थे। दर्पण टूट गया था, लेकिन उसके टुकड़े और भी तीखे हो गए थे।"
					},
					"type": "speech",
					"speaker": "narrator"
				}
			...
			"dialogue": [
				...
				},
				{
					"content": {
						...
						"vietnamese": "Phải. Khát vọng của các ngươi thèm muốn sự bình yên của những kẻ ở lại rừng.",
			...
			"lose_dialogue": [
				...
				},
				{
					...
					"content": {
						...
						"english": "Come again... Bring deeper despair... and the forest will grow stronger... Heh heh...",
						"japanese": "また来るがいい… もっと深い絶望をもたらすなら… 森はさらに強くなるだろう… クク…",
						"chinese": "再来吧……带来更深的绝望……森林就会更强大……呵呵……",
						"french": "Reviens… Apporte un désespoir plus profond… et la forêt deviendra plus forte… Huhu…",
						"spanish": "Vuelve… Trae una desesperación más profunda… y el bosque se hará más fuerte… Jejeje…",
						"vietnamese": "Hãy quay lại… Mang đến sự tuyệt vọng sâu sắc hơn… khu rừng sẽ trở nên mạnh mẽ hơn… Khà khà…",
