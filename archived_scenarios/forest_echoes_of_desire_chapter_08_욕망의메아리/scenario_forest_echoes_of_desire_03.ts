	...
	"rooms": [
			...
			"dialogue": [
				...
				},
				{
					"content": {
						...
						"english": "It's not a physical issue. For an illness that emerged after returning from the forest... it's far too spiritual.",
						"japanese": "肉体の問題ではない。森から戻ってから発病したにしては… あまりにも霊的だ。",
						"chinese": "这不是肉体的问题。对于从森林回来后才发病的症状来说……它太过于灵性了。",
						"french": "Ce n'est pas un problème physique. Pour une maladie apparue après être revenu de la forêt… c'est bien trop spirituel.",
						"spanish": "No es un problema físico. Para una enfermedad que apareció después de volver del bosque... es demasiado espiritual.",
						"vietnamese": "Không phải là vấn đề thể xác. Đối với một căn bệnh phát tác sau khi trở về từ rừng… nó quá mức tâm linh.",
						"thai": "ไม่ใช่ปัญหาทางกาย สำหรับอาการป่วยที่เกิดขึ้นหลังจากกลับจากป่า… มันเป็นเรื่องจิตวิญญาณมากเกินไป",
						"hindi": "यह शारीरिक समस्या नहीं है। जंगल से लौटने के बाद हुई बीमारी के लिए... यह बहुत ही आध्यात्मिक है।"
					},
					"emotion": "base",
					"speaker": "cedar",
					"type": "speech"
				...
				},
				{
					"content": {
						...
						"english": "The forest encroached upon their inner selves. Regret, longing, and jealousy.",
			...
			"dialogue": [
				...
				},
				{
					...
					"content": {
						...
						"english": "There's a sound coming from deep within the forest. A murmur of countless voices mixed together.",
						"japanese": "森の深い所から音が聞こえる。数多くの声が混じり合ったつぶやきが。",
						"chinese": "森林深处传来一个声音。无数声音混杂的低语。",
						"french": "Un son vient des profondeurs de la forêt. Un murmure de nombreuses voix entremêlées.",
						"spanish": "Hay un sonido que viene de lo más profundo del bosque. Un murmullo de innumerables voces mezcladas.",
						"vietnamese": "Có một âm thanh vọng ra từ sâu thẳm trong rừng. Một tiếng lầm bầm của vô số giọng nói hòa lẫn vào nhau.",
				...
				},
				{
					"content": {
						...
						"spanish": "No, es la forma en que el bosque habla. Sus deseos se convirtieron en su voz.",
						"vietnamese": "Không, đó là cách rừng nói. Khát khao của họ đã trở thành tiếng nói của rừng.",
				...
				},
				{
					...
					"content": {
						...
						"english": "The forest is now the 'Mirror of Choices'. It reflects what's deepest within you.",
						"japanese": "森は今や「選択の鏡」だ。お前の内にある最も深いものを映し出す。",
						"chinese": "森林现在是‘选择之镜’。它映照出你内心最深处的东西。",
						"french": "La forêt est maintenant le 'Miroir des Choix'. Elle reflète ce qu'il y a de plus profond en toi.",
						"spanish": "El bosque es ahora el 'Espejo de las Elecciones'. Refleja lo más profundo de ti.",
						"vietnamese": "Rừng giờ là 'Gương Lựa Chọn'. Nó phản chiếu điều sâu thẳm nhất trong ngươi.",
		...
		},
		{
			"dialogue": [
				...
				{
					"content": {
						"korean": "특정 지역에선 사람들의 모습이 왜곡되어 보여. 때로는 타인의 모습으로 비치기도 하고.",
						"english": "In certain areas, people's forms appear distorted. Sometimes, they even reflect as others.",
						"japanese": "特定の地域では、人々の姿が歪んで見える。時には、他人の姿として映ることもある。",
						"chinese": "在某些区域，人们的形象会扭曲。有时，甚至会映照出他人的模样。",
						"french": "Dans certaines zones, l'apparence des gens est déformée. Parfois, ils reflètent même l'image d'autres personnes.",
						"spanish": "En ciertas zonas, las formas de las personas se ven distorsionadas. A veces, incluso se reflejan como otros.",
						"vietnamese": "Ở một số vùng, hình dạng người ta bị méo mó. Đôi khi, còn phản chiếu thành hình bóng của người khác.",
						"thai": "ในบางพื้นที่ รูปร่างของผู้คนบิดเบี้ยว บางครั้งสะท้อนเป็นภาพของผู้อื่นด้วยซ้ำ",
						"hindi": "कुछ क्षेत्रों में, लोगों के रूप विकृत दिखते हैं। कभी-कभी, वे दूसरों के रूप में भी दिखाई देते हैं।"
					},
					"speaker": "cedar",
					"type": "speech",
					"emotion": "sad"
				...
				},
				{
					...
					"type": "speech",
					"content": {
						"korean": "맞아. 병든 자들 주변에서 아름답지만 스산한 환영 꽃이 피어나. 그건 그들의 갈망이 현실로 나타나는 증거야.",
						"english": "Exactly. Around the afflicted, beautiful yet eerie phantom flowers bloom. They're proof their yearning is manifesting.",
						"japanese": "そうだ。病んだ者たちの周りには、美しくも不気味な幻影の花が咲き誇る。それは彼らの渇望が現実となった証なのだ。",
						"chinese": "没错。在病患周围，会开出美丽却诡异的幻影之花。那是他们渴望化为现实的证据。",
						"french": "Exactement. Autour des affligés, de belles mais étranges fleurs fantômes éclosent. C'est la preuve que leurs désirs se manifestent.",
						"spanish": "Exacto. Alrededor de los afligidos, florecen hermosas pero inquietantes flores fantasma. Son la prueba de que su anhelo se está manifestando.",
						"vietnamese": "Đúng vậy. Xung quanh những kẻ bệnh tật, những đóa hoa ảo ảnh đẹp nhưng rùng rợn nở rộ. Đó là bằng chứng cho sự khao khát của họ đang hiện thực hóa.",
						"thai": "ถูกต้อง รอบๆ ผู้ป่วย ดอกไม้มายาที่สวยงามแต่ชวนขนลุกจะผลิบาน นั่นคือหลักฐานว่าความปรารถนาของพวกเขาได้สำแดงออกมาแล้ว",
						"hindi": "सही है। पीड़ित लोगों के आस-पास, सुंदर लेकिन डरावने प्रेत फूल खिलते हैं। वे इस बात का सबूत हैं कि उनकी लालसा प्रकट हो रही है।"
					}
				},
				{
					"content": {
				...
				},
				{
					...
					"content": {
						...
						"english": "The forest merely reflects. The choice was yours. Regret and jealousy sickened the forest.",
						"japanese": "森はただ映し出すだけだ。選択はお前たちのものだった。後悔と嫉妬が森を病ませたのだ。",
						"chinese": "森林只是映照。选择权在你们。后悔和嫉妒使森林病倒了。",
						"french": "La forêt ne fait que refléter. Le choix vous appartenait. Le regret et la jalousie ont rendu la forêt malade.",
						"spanish": "El bosque solo refleja. La elección fue vuestra. El arrepentimiento y los celos enfermaron al bosque.",
						"vietnamese": "Rừng chỉ phản chiếu. Lựa chọn là của các ngươi. Hối tiếc và ghen tị đã làm cho rừng bệnh.",
						"thai": "ป่าเพียงแค่สะท้อน การเลือกเป็นของพวกเจ้าเอง ความเสียใจและความอิจฉาริษยาทำให้ป่าป่วย",
						"hindi": "जंगल तो बस दर्शाता है। चुनाव तुम्हारा था। पछतावे और ईर्ष्या ने जंगल को बीमार कर दिया।"
					}
				}
			],
			"id": 5
		},
		{
			...
			"dialogue": [
				...
				},
				{
					...
					"emotion": "angry",
					"content": {
						"korean": "이제 돌이킬 수 없어. 거울은 이미 균열이 생겼고, 숲은 모든 것을 빨아들일 준비를 하고 있어.",
						"english": "It's irreversible now. The mirror is already cracked, and the forest is ready to devour everything.",
						"japanese": "もう後戻りはできない。鏡には既に亀裂が入り、森はすべてを吸い込む準備をしている。",
						"chinese": "现在已无法挽回。镜子已经开裂，森林正准备吞噬一切。",
						"french": "C'est irréversible maintenant. Le miroir est déjà fissuré, et la forêt est prête à tout engloutir.",
						"spanish": "Ya es irreversible. El espejo ya está agrietado, y el bosque está listo para absorberlo todo.",
						"vietnamese": "Giờ không thể quay lại được nữa. Gương đã nứt, và rừng đang chuẩn bị nuốt chửng mọi thứ.",
						"thai": "ตอนนี้มันแก้ไขไม่ได้แล้ว กระจกแตกแล้ว และป่าก็พร้อมที่จะกลืนกินทุกสิ่ง",
						"hindi": "अब यह अपरिवर्तनीय है। दर्पण पहले ही टूट चुका है, और जंगल सब कुछ निगलने के लिए तैयार है।"
					}
				},
				{
					"content": {
				...
				{
					"content": {
						"korean": "숲의 영혼을 정화해야 해. 이 왜곡된 거울을 깨뜨리지 않으면, 모두가 자기 안의 악마를 보게 될 거야.",
						"english": "We must purify the forest's soul. If we don't shatter this warped mirror, everyone will see the demons within themselves.",
						"japanese": "森の魂を浄化しなければならない。この歪んだ鏡を壊さなければ、皆が自分の中の悪魔を見ることになるだろう。",
						"chinese": "我们必须净化森林的灵魂。如果不打破这面扭曲的镜子，所有人都会看到自己内心的恶魔。",
						"french": "Nous devons purifier l'âme de la forêt. Si nous ne brisons pas ce miroir déformé, chacun verra les démons en lui-même.",
						"spanish": "Debemos purificar el alma del bosque. Si no rompemos este espejo distorsionado, todos verán los demonios dentro de sí mismos.",
						"vietnamese": "Chúng ta phải thanh tẩy linh hồn khu rừng. Nếu không phá vỡ tấm gương méo mó này, mọi người sẽ thấy ác quỷ trong chính mình.",
						"thai": "เราต้องชำระล้างจิตวิญญาณของป่า ถ้าเราไม่ทำลายกระจกบิดเบี้ยวนี้ ทุกคนจะได้เห็นปีศาจในตัวพวกเขาเอง",
						"hindi": "हमें जंगल की आत्मा को शुद्ध करना होगा। यदि हम इस विकृत दर्पण को नहीं तोड़ते हैं, तो हर कोई अपने भीतर के राक्षसों को देखेगा।"
					},
					"speaker": "cedar",
					"type": "speech",
					"emotion": "sad"
			...
			"dialogue": [
				...
				},
				{
					...
					"content": {
						...
						"english": "Be careful. That's no mere monster. It's the materialized form of the forest's distorted desires.",
						"japanese": "気をつけろ。あれは単なる怪物ではない。森の歪んだ欲望が具現化した存在だ。",
						"chinese": "小心。那不仅仅是怪物。它是森林扭曲欲望的具象化。",
						"french": "Attention. Ce n'est pas un simple monstre. C'est la forme matérialisée des désirs déformés de la forêt.",
						"spanish": "Ten cuidado. Eso no es un simple monstruo. Es la forma materializada de los deseos distorsionados del bosque.",
						"vietnamese": "Cẩn thận. Đó không phải là một con quái vật đơn thuần. Đó là hiện thân của những ham muốn méo mó của khu rừng.",
						"thai": "ระวังให้ดี นั่นไม่ใช่แค่สัตว์ประหลาดธรรมดา มันคือรูปธรรมของความปรารถนาที่บิดเบี้ยวของป่า",
						"hindi": "सावधान रहो। वह सिर्फ एक राक्षस नहीं है। यह जंगल की विकृत इच्छाओं का मूर्त रूप है।"
					}
				},
				{
					"speaker": "boss",
					...
					"content": {
						...
						"vietnamese": "Cuối cùng các ngươi cũng đến rồi. Những kẻ sẽ bị giam cầm trong gương của ta.",
				...
				},
				{
					...
					"content": {
						...
						"spanish": "El arrepentimiento, la envidia y el anhelo dentro de ustedes pronto los consumirán.",
						"vietnamese": "Sự hối tiếc, ghen tị và khao khát trong các ngươi sẽ sớm nuốt chửng các ngươi.",
			...
			"lose_dialogue": [
				{
					...
					"content": {
						...
						"vietnamese": "Những kẻ yếu đuối. Ngươi thậm chí không có dũng khí đối mặt với chính mình.",
				...
				},
				{
					...
					"content": {
						...
						"spanish": "Es inútil. El espejo dentro de ti solo reflejará una desesperación más profunda.",
						"vietnamese": "Vô ích thôi. Gương trong ngươi sẽ chỉ phản chiếu tuyệt vọng sâu hơn mà thôi.",
			...
			"win_dialogue": [
				{
					...
					"content": {
						...
						"english": "...So you break the mirror after all. But the shadow within you... will not disappear.",
						"japanese": "…結局、鏡を壊すのか。だが、お前たちの心の中の影は…消えないだろう。",
						"chinese": "……终究还是打破了镜子。但你们内心的影子……不会消失。",
						"french": "...Vous brisez le miroir après tout. Mais l'ombre en vous... ne disparaîtra pas.",
						"spanish": "...Al final rompes el espejo. Pero la sombra dentro de ustedes... no desaparecerá.",
						"vietnamese": "...Cuối cùng các ngươi cũng phá vỡ tấm gương. Nhưng cái bóng trong các ngươi... sẽ không biến mất.",
						"thai": "...ในที่สุดเจ้าก็ทำลายกระจกจนได้ แต่เงาในตัวพวกเจ้า... จะไม่หายไป",
						"hindi": "...आखिरकार तुम दर्पण तोड़ देते हो। लेकिन तुम्हारे अंदर की परछाई... गायब नहीं होगी।"
					}
				},
				{
					"content": {
				...
				},
				{
					...
					"content": {
						...
						"french": "Les ombres de la forêt sont profondes. Une fissure, une fois formée, ne se referme pas facilement.",
						"spanish": "Las sombras del bosque son profundas. Una grieta, una vez abierta, no cicatriza fácilmente.",
				...
				},
				{
					...
					"type": "speech",
					"content": {
						"korean": "숲의 왜곡된 거울은 잠시 멈췄다. 그러나 그 안에서 비춰진 진실은, 모두의 마음에 새로운 균열을 남겼다. 아직 끝나지 않았다.",
						"english": "The forest's twisted mirror paused. Yet the truth it reflected left new cracks in every heart. It's not over yet.",
						"japanese": "森の歪んだ鏡は一時停止した。しかし、その中に映し出された真実は、皆の心に新たな亀裂を残した。まだ終わってはいない。",
						"chinese": "森林扭曲的镜子暂时停滞了。然而，其中映照出的真相，在每个人的心中留下了新的裂痕。一切尚未结束。",
						"french": "Le miroir tordu de la forêt s'est figé un instant. Pourtant, la vérité qu'il reflétait a laissé de nouvelles fissures dans tous les cœurs. Ce n'est pas encore fini.",
						"spanish": "El espejo distorsionado del bosque se detuvo un momento. Sin embargo, la verdad que reflejó dejó nuevas grietas en cada corazón. Todavía no ha terminado.",
						"vietnamese": "Gương méo mó của rừng tạm dừng. Nhưng sự thật phản chiếu trong đó đã để lại những vết nứt mới trong mọi trái tim. Vẫn chưa kết thúc.",
						"thai": "กระจกบิดเบี้ยวของป่าหยุดชะงักชั่วครู่ ทว่าความจริงที่สะท้อนออกมา ได้ทิ้งรอยร้าวใหม่ไว้ในทุกดวงใจ ยังไม่จบลง",
						"hindi": "वन का विकृत दर्पण थम गया। फिर भी, उसने जो सत्य प्रतिबिंबित किया, उसने हर हृदय में नई दरारें छोड़ दीं। यह अभी खत्म नहीं हुआ है।"
					}
				}
			]
		}
