			...
			"dialogue": [
				{
					...
					"content": {
						...
						"french": "Au plus profond de la forêt. Étrangement calme, et pourtant quelque chose n'allait pas.",
			...
			"dialogue": [
				...
				},
				{
					"content": {
						...
						"french": "Les racines des vieux arbres bougeaient subtilement, comme si elles se chuchotaient des secrets.",
						"spanish": "Las raíces de los árboles viejos se movían sutilmente como si se susurraran entre sí.",
						...
						"hindi": "पुराने पेड़ों की जड़ें धीरे से हिलने लगीं, मानो एक-दूसरे से कानाफूसी कर रही हों।"
					},
					"type": "speech",
					"emotion": "base",
					"speaker": "narrator"
			...
			"lose_dialogue": [
				{
					...
					"content": {
						...
						"french": "Oui, plongez plus profondément. Votre cupidité ne fera que me rendre plus fort !",
						"spanish": "Sí, adéntrense más. ¡Vuestra codicia solo me hará más fuerte!",
						"vietnamese": "Phải, hãy lún sâu hơn nữa đi. Lòng tham của các ngươi sẽ chỉ khiến ta mạnh hơn thôi!",
			...
			"dialogue": [
				...
				},
				{
					"content": {
						...
						"vietnamese": "Ngay cả khát khao thuần khiết của ngươi cuối cùng cũng chỉ nuôi dưỡng ta mà thôi.",
			...
			"win_dialogue": [
				{
					"content": {
						...
						"spanish": "...Al final, tú tampoco eres diferente. El deseo también se agita dentro de ti...",
						"vietnamese": "...Cuối cùng, ngươi cũng chẳng khác gì. Ham muốn cũng chỉ đang cựa quậy bên trong ngươi mà thôi...",
				...
				},
				{
					...
					"speaker": "narrator",
					"content": {
						"korean": "괴물은 사라졌지만, 숲에 남은 욕망의 잔재는 여전히 미세하게 흔들렸다. 진정한 정화는 아직 멀었다.",
						"english": "The monster is gone, but the remnants of desire in the forest still subtly tremble. True purification is still far off.",
						"japanese": "化け物はいなくなったが、森に残る欲望の残滓は依然として微かに揺らめいていた。真の浄化はまだ遠い。",
						"chinese": "怪物消失了，但森林中残留的欲望仍在微微颤动。真正的净化还远未到来。",
						"french": "Le monstre a disparu, mais les vestiges du désir dans la forêt tremblent encore subtilement. La véritable purification est encore loin.",
						"spanish": "El monstruo ha desaparecido, pero los restos del deseo en el bosque todavía tiemblan sutilmente. La verdadera purificación aún está lejos.",
						"vietnamese": "Quái vật đã biến mất, nhưng tàn dư của ham muốn trong rừng vẫn còn rung động nhẹ. Sự thanh tẩy đích thực vẫn còn xa.",
						...
						"hindi": "राक्षस चला गया है, लेकिन जंगल में बची हुई इच्छा के अवशेष अभी भी सूक्ष्म रूप से कांप रहे हैं। सच्ची शुद्धि अभी भी बहुत दूर है।"
					},
					"type": "speech"
				}
			]
