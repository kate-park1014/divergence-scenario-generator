			...
			"dialogue": [
				{
					...
					"content": {
						...
						"spanish": "El camino hacia el corazón del bosque. Un murmullo de dolor detuvo mis pasos.",
						"vietnamese": "Con đường dẫn vào sâu thẳm rừng. Tiếng rên rỉ của đau đớn níu giữ bước chân.",
			...
			"dialogue": [
				...
				},
				{
					"content": {
						...
						"english": "The happiness I left behind in the forest... it feels like it's gnawing at me.",
				...
				},
				{
					...
					"content": {
						...
						"french": "Oui... parce que ceux qui sont restés dans la forêt... semblent trop heureux...",
						"spanish": "Sí... porque los que se quedaron en el bosque... parecen demasiado felices...",
				...
				},
				{
					"content": {
						...
						"english": "I instinctively feel that the root of the illness lies not in the body, but in the soul.",
						"japanese": "病の根源が肉体ではなく魂にあることを直感する。",
						"chinese": "直觉告诉我，疾病的根源不在肉体，而在灵魂。",
						"french": "Je sens intuitivement que la racine de la maladie ne réside pas dans le corps, mais dans l'âme.",
						"spanish": "Intuyo que la raíz de la enfermedad no está en el cuerpo, sino en el alma.",
						"vietnamese": "Trực giác mách bảo tôi rằng căn nguyên của bệnh không nằm ở thể xác, mà ở linh hồn.",
			...
			"dialogue": [
				...
				},
				{
					...
					"content": {
						...
						"english": "The regrets of those who left... clash with the happiness of those who remained in the forest...",
						"japanese": "去っていった者たちの後悔が…森に残った者たちの幸せとぶつかり…",
						"chinese": "离去者的悔恨…与留在森林里的人的幸福发生冲突…",
						"french": "Les regrets de ceux qui sont partis... se heurtent au bonheur de ceux qui sont restés dans la forêt...",
						"spanish": "Los remordimientos de los que se fueron... chocan con la felicidad de los que se quedaron en el bosque...",
						"vietnamese": "Sự hối tiếc của những người đã rời đi... va chạm với hạnh phúc của những người ở lại rừng...",
				...
				},
				{
					...
					"content": {
						...
						"spanish": "El bosque... se ha convertido en un espejo que refleja todas nuestras emociones.",
			...
			"dialogue": [
				...
				},
				{
					...
					"content": {
						...
						"english": "The forest's murmurs grew fiercer. It's spiritual noise, a cacophony of countless voices.",
						"japanese": "森のざわめきがさらに激しくなった。無数の声が混じり合う霊的なノイズだ。",
						"chinese": "森林的低语更加猛烈。那是无数声音混杂的灵性噪音。",
						"french": "Les murmures de la forêt devinrent plus féroces. C'est un bruit spirituel, une cacophonie de voix innombrables.",
						"spanish": "Los murmullos del bosque se hicieron más feroces. Es ruido espiritual, una cacofonía de innumerables voces.",
						"vietnamese": "Tiếng thì thầm của rừng trở nên dữ dội hơn. Đó là tạp âm tâm linh, một sự hỗn loạn của vô số giọng nói.",
						"thai": "เสียงกระซิบของป่ารุนแรงขึ้น มันคือเสียงรบกวนทางจิตวิญญาณ เสียงโกลาหลของเสียงนับไม่ถ้วน",
						"hindi": "जंगल की फुसफुसाहट और तेज हो गई। यह आध्यात्मिक शोर है, अनगिनत आवाजों का एक कोलाहल।"
					},
					"type": "speech",
					"speaker": "narrator"
				},
			...
			"win_dialogue": [
				{
					"content": {
						...
						"vietnamese": "...Cuối cùng thì ngươi cũng đã ngăn cản được. Nhưng... đây không phải là kết thúc.",
				...
				},
				{
					...
					"content": {
						...
						"french": "La forêt resta silencieuse un instant. Maintenant, son avenir repose entre leurs mains.",
						"spanish": "El bosque permaneció en silencio por un momento. Ahora, el futuro del bosque está en sus manos.",
						"vietnamese": "Khu rừng im lặng một lát. Giờ đây, tương lai của khu rừng nằm trong tay họ.",
			...
			"dialogue": [
				...
				},
				{
					...
					"content": {
						...
						"english": "I am merely… your mirror. The jealousy of the abandoned, the happiness of those left behind…",
						"japanese": "私はただ…お前たちの鏡にすぎない。捨てられた者たちの嫉妬、残された者たちの幸福…",
						"chinese": "我只是…你们的镜子。被遗弃者的嫉妒，被留下者的幸福…",
						"french": "Je ne suis que… votre miroir. La jalousie des abandonnés, le bonheur de ceux qui sont restés…",
						"spanish": "Soy simplemente… vuestro espejo. Los celos de los abandonados, la felicidad de los que quedan…",
						"vietnamese": "Ta chỉ là… tấm gương của các ngươi. Nỗi ghen tị của những kẻ bị bỏ rơi, niềm hạnh phúc của những kẻ còn lại…",
