			...
			dialogue: [
				{
					...
					content: {
						...
						spanish:
							'Vosotros, los que regresasteis... Vuestras elecciones crearon la sombra que me dio forma.',
						vietnamese:
							'Những kẻ trở về... Lựa chọn của các ngươi đã hóa thành bóng tối tạo ra ta.',
				...
				},
				{
					...
					content: {
						...
						english:
							'I am your yearning. The twisted jealousy towards those who remained in the forest.',
						japanese: '私はお前たちの渇望。森に残った者たちへの歪んだ嫉妬だ。',
						chinese: '我就是你们的渴望。对留在森林里的人们扭曲的嫉妒。',
						french:
							'Je suis votre désir ardent. La jalousie tordue envers ceux qui sont restés dans la forêt.',
						spanish:
							'Soy vuestro anhelo. La retorcida envidia hacia los que permanecieron en el bosque.',
						vietnamese:
							'Ta là khát khao của các ngươi. Nỗi ghen tị méo mó với những kẻ đã ở lại trong rừng.',
			...
			lose_dialogue: [
				...
				},
				{
					...
					content: {
						...
						english:
							"The forest's whispers grew stronger. Its craving seemed to devour everything.",
						...
						spanish:
							'Los susurros del bosque se hicieron más fuertes. Su ansia parecía devorarlo todo.',
						vietnamese:
							'Lời thì thầm của rừng cây càng lúc càng mạnh. Khát khao đó dường như muốn nuốt chửng mọi thứ.',
